...
class variableDec(Node):
    ...
    def imprimir(self, ident):
        ...
        if (self.son1.son1.name.encode('ascii','ignore') == "Texto"):
            self.son1.imprimir(" " + ident)
            self.son2.imprimir(" " + ident)
            self.son3.imprimir(" " + ident)
        else:
...
class INTA(Node):
    ...
    def imprimir(self, ident):
        print (ident + "IntA: " + str(self.name))
        codeGenetor(self.name, 16)
...
class FUNC(Node):
    ...
    def imprimir(self, ident):
        codeGenetor(self.name, 18)
        print (ident + "Funcion: " + self.name)
